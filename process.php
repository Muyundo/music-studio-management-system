          ...
          <div class="col-md-8">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">select song under <strong>Action</strong> to update progress</h3>
              </div>
            ...
            <td>
           <a href="process.php?editsongstatus=<?php echo $status['status_id']; ?>" class="edit_btn" > <i class="fas fa-edit"></i>
...
<div class="card card-info">
  ...
  <div class="card-header">
    ...
    <div class="card-header">
    <h3 class="card-title"><strong>UPDATE PROGRESS HERE</strong></h3>
  </div>
  <div class="card-body">
    <?php
